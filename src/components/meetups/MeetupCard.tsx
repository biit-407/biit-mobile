...
const MeetupCard = ({ id, timestamp, duration, location, userList, key }: MeetupCardProps) => {
    ...
    return <ThemedCard>
        <Box style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
            <Text variant="header" style={{ flex: 1 }}>Meetup</Text>
            <Text variant='subheader' style={{ flex: 1, textAlign: 'right', paddingRight: 8 }}>{id}</Text>
        </Box>
