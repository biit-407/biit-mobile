...
import { CommunityAdministrationPageRouteProp, CommunityAdministrationPageNavigationProp } from "../../routes";
...
export default function CommunityAdministrationPage({ navigation }: CommunityAdministrationPageProps) {
