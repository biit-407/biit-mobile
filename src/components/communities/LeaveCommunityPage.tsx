...
import { LeaveCommunityPageRouteProp, LeaveCommunityPageNavigationProp } from "../../routes";
...
export default function LeaveCommunityPage({ navigation }: LeaveCommunityPageProps) {
    return(
