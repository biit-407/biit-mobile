...
import { CreateCommunityPageRouteProp, CreateCommunityPageNavigationProp } from "../../routes";
...
export default function CreateCommunityPage({ navigation }: CreateCommunityPageProps) {
